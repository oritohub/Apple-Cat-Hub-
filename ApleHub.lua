...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=112756846672467";
v24.Parent = v23;
...
local v170 = v16.Sea:AddToggle("ToggleTPVolcano", {
    Title = "Bay Đến Prehistoric Island ",
    Description = "",
    Default = false
});
